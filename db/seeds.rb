User.create!(email: "cook@cook.com", encrypted_password: "123456", first_name: "Han", surname: "solo")
User.create!(email: "cook1@cook.com", encrypted_password: "123456", first_name: "Kane", surname: "Black")
